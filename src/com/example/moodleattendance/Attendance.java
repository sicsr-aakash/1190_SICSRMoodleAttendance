...
public class Attendance extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			btnImgPrev.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(index == 0 || index < 0){
						Toast.makeText(getApplicationContext(), "You are viewing the first student.", Toast.LENGTH_SHORT).show();						
					}else{
						index--;
						txtViewUserFullName.setText(st_name.get(index));
						txtViewUserUserName.setText(st_username.get(index));
	...
	void saveAttendance(){
		...
		builder.setTitle("Alert").setMessage("Do you wnat to save this attendance.").setCancelable(false)
		.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int idd) {
								try {
									...
									Toast.makeText(getApplicationContext(), "Attendance saved successfuly.", Toast.LENGTH_SHORT).show();
